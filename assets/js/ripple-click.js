document.addEventListener('click', function(event) {
    ...
    function createRippleCircle(left, top, size, borderWidth, delay) {
        ...
        rippleCircle.style.left = `${left - size / 2}px`; // Center the circle on the click point
        rippleCircle.style.top = `${top - size / 2}px`;  // Center the circle on the click point
    ...
    // Get the position of the click and create 3 circles (ripples)
